document.addEventListener('DOMContentLoaded', () => {
    ...
    boxes.forEach((box, index) => {
        box.addEventListener('click', () => {
            ...
            if (index === 0) {
                box.innerHTML = '<iframe width="150" height="150" src="https://www.youtube.com/embed/op0aJGB165A" frameborder="0" allowfullscreen></iframe>';
            } else if (index === 1) {
                box.innerHTML = '<iframe width="150" height="150" src="https://www.youtube.com/embed/ufit4zSvTJ0" frameborder="0" allowfullscreen></iframe>';
            } else if (index === 2) {
                box.innerHTML = '<iframe width="150" height="150" src="https://www.youtube.com/embed/3AL0I-V88Do" frameborder="0" allowfullscreen></iframe>';
            } else if (index === 3) {
